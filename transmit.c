...
static void fill_example_gps_data(struct ODID_UAS_Data *uasData) {
    ...
    uasData->Location.Latitude = 42.1686930;
    uasData->Location.Longitude = 12.7860519;
...
int main(int argc, char *argv[])
{
    ...
    if (config.use_gps) {
        printf("GPS mode currently disabled in this build.\n");
        cleanup(EXIT_FAILURE);
    } else {
        printf("Transmitting static example data...\n");
