...
FAMS = {
    ...
    "O23":    dict(s24=True, s52=False, s58=True, mu=12.0, sig=5.0,  peak=24.0, prior=0.30),
    # AUTEL Skylink 2/3.0)
    ...
    # FPV Digitale Caddx ( Solo 5.8 BW di 3-4 MHz tipico )
    "CADDX":   dict(s24=False, s52=False, s58=True, mu=20.0, sig=3.0,  peak=22.0, prior=0.25),
    # FPV Analogico ( Solo 5.8 BW di 3-4 MHz tipico )
    "ANALOG":   dict(s24=False, s52=False, s58=True, mu=2.0, sig=3.0,  peak=7.0, prior=0.25),
